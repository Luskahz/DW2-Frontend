    ...
    data.map((property) => {
        ...
        <div class="property-card">
            ...
            <div class="texts">
                ...
                <button onclick="propareToEdit(${property.id},'${property.type}', '${property.adress}', ${property.rooms}, '${property.property}')">Editar</button>
            </div>
        </div>
        `
    })
...
const propareToEdit =(id, type, adress, rooms, property) => {
